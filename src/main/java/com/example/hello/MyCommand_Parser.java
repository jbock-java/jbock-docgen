...
/**
 * <h3>Generated by <a href="https://github.com/h908714124/jbock">jbock 3.6.003</a></h3>
...
final class MyCommand_Parser {
  ...
  private enum Option {
    ...
    VERBOSITY(Collections.singletonList("--verbosity"), null, Collections.singletonList("An {@code @Option} is a named option."), "--verbosity VERBOSITY");
