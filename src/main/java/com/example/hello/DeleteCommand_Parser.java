...
/**
 * <h3>Generated by <a href="https://github.com/h908714124/jbock">jbock 4.0.000</a></h3>
...
final class DeleteCommand_Parser {
  ...
  private void printOption(Option option, String messageKey, String names) {
    String names_padded_24_characters = String.format("  %1$-22s", names);
    String message = messageKey.isEmpty() ? null : messages.get(messageKey);
    List<String> tokens = new ArrayList<>();
    tokens.add(names_padded_24_characters);
