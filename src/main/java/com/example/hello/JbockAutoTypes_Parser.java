...
final class JbockAutoTypes_Parser {
  ...
  private enum Option {
    BIG_DECIMAL(Collections.singletonList("--BigDecimal"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.math.BigDecimal::new")),

    BIG_INTEGER(Collections.singletonList("--BigInteger"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.math.BigInteger::new")),

    FILE(Collections.singletonList("--File"), null, false, OptionalInt.empty(), Arrays.asList(
    ...
    LOCAL_DATE(Collections.singletonList("--LocalDate"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.time.LocalDate::parse")),

    PATH(Collections.singletonList("--Path"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.nio.file.Paths::get")),

    PATTERN(Collections.singletonList("--Pattern"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.util.regex.Pattern::compile")),

    STRING(Collections.singletonList("--String"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.util.function.Function.identity()")),

    U_RI(Collections.singletonList("--URI"), null, false, OptionalInt.empty(), Collections.singletonList("Mapped by: java.net.URI::create"));
