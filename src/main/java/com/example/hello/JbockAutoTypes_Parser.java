...
/**
 * Generated by
 * <a href="https://github.com/h908714124/jbock">jbock 2.8.9</a>
 */
final class JbockAutoTypes_Parser {
  ...
  private static class Tokenizer {
    ...
    void printUsage() {
      ...
      descriptionFromJavadoc.add("that can be used without custom mappers or collectors in jbock 2.8.9.");
  ...
  private enum Option {
    ...
    FILE("File", null, "null", OptionalInt.empty(), "FILE", Arrays.asList(
