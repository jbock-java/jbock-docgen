...
final class JbockAutoTypes_Parser {
  ...
  void printOnlineHelp() {
    ...
    Collections.addAll(description, "that can be used without a custom mapper in jbock 4.0.000.".split("\\s+", -1));
  ...
  private void printOption(Option option, String messageKey, String names) {
    String names_padded_26_characters = String.format("  %1$-24s", names);
    String message = messageKey.isEmpty() ? null : messages.get(messageKey);
    List<String> tokens = new ArrayList<>();
    tokens.add(names_padded_26_characters);
