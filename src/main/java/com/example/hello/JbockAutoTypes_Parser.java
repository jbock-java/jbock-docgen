...
/**
 * Generated by
 * <a href="https://github.com/h908714124/jbock">jbock 2.8.7</a>
 */
final class JbockAutoTypes_Parser {
  ...
  private static class Tokenizer {
    ...
    ParseResult parse(String[] args) {
      try {
        Optional<JbockAutoTypes> result = parse(Arrays.asList(args).iterator());
        if (result.isPresent()) {
    ...
    Optional<JbockAutoTypes> parse(Iterator<String> tokens) {
      boolean first = true;
      int position = 0;
    ...
    void printUsage() {
      ...
      descriptionFromJavadoc.add("that can be used without custom mappers or collectors in jbock 2.8.7.");
  ...
  private static class ParserState {
    ...
    int readPositional(int position, String token) {
      ...
      positionalParsers.get(position).read(token);
      return positionalParsers.get(position).positionIncrement();
    }
