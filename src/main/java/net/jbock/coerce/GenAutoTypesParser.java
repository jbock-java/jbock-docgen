...
public class GenAutoTypesParser {
    ...
    static void notMain() throws IOException {

        String sourceFile = "src/main/java/com/example/helloworld/" + GEN_CLASS_NAME + ".java";
        String targetFile = "src/main/java/com/example/helloworld/" + GEN_CLASS_NAME + "_Parser.java";
