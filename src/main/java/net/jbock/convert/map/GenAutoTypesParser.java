...
import static net.jbock.convert.map.GenAutoTypes.AUTO_TYPES;
import static net.jbock.convert.map.GenAutoTypes.AUTO_TYPES_CLASSNAME;
import static net.jbock.convert.map.GenAutoTypes.AUTO_TYPES_PARSER;
